...
public class VoiceInputMethodService extends InputMethodService {
    ...
    private String currentLanguage = "bn-BD"; // ডিফল্ট বাংলা
    ...
    public View onCreateInputView() {
        ...
        btnBn.setOnClickListener(v -> currentLanguage = "bn-BD");
        btnEn.setOnClickListener(v -> currentLanguage = "en-US");
        btnAr.setOnClickListener(v -> currentLanguage = "ar-SA");
        btnHi.setOnClickListener(v -> currentLanguage = "hi-IN");
